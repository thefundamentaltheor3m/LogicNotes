...
\newcommand{\lrsquig}{\leftrightsquigarrow}
...
\newcommand{\isleto}{\text{ is logically equivalent to }}
...
\newcommand{\vl}{\vdash_{\bL}}

\renewcommand{\v}{\mathbf{v}}
\newcommand{\vof}[1]{\v\!\parenth{#1}}
\newcommand{\w}{\mathbf{w}}
\newcommand{\wof}[1]{\w\of{#1}}

% Ch 2

\newcommand{\ol}[1]{\overline{#1}}
\newcommand{\Rb}{\ol{R}}
\newcommand{\Rbof}[1]{\Rb\!\parenth{#1}}
\newcommand{\fb}{\overline{f}}
\newcommand{\fbof}[1]{\fb\!\parenth{#1}}
\newcommand{\gb}{\overline{g}}
\newcommand{\gbof}[1]{\gb\!\parenth{#1}}
\newcommand{\Rof}[1]{R\!\parenth{#1}}

\newcommand{\A}{\mathcal{A}}
\renewcommand{\B}{\mathcal{B}}
\renewcommand{\L}{\mathcal{L}}

\newcommand{\fola}{first-order language}
\newcommand{\folo}{first-order logic}
\newcommand{\fos}{first-order structure}
\newcommand{\Letla}{Let $\L$ be a \fola}
\newcommand{\letla}{let $\L$ be a \fola}
\newcommand{\Letal}{Let $\A$ be an $\L$-structure}
\newcommand{\letal}{let $\A$ be an $\L$-structure}
\newcommand{\Vola}{Let $\v$ be a valuation of $\L$ in $\A$}
\newcommand{\vola}{let $\v$ be a valuation of $\L$ in $\A$}

\newcommand{\vbrac}[1]{\v\!\brac{#1}}
\newcommand{\wbrac}[1]{\w\!\brac{#1}}
% \renewcommand{\models}{\vDash}

\newcommand{\K}{\mathbf{K}}
\newcommand{\KL}{\K_{\L}}
\newcommand{\vkl}{\vdash_{\KL}}
...
\newcommand{\ZFA}{Zermelo-Fraenkel Axioms}
\newcommand{\ZFCA}{Zermelo-Fraenkel Axioms with the Axiom of Choice}
\newcommand{\AC}{Axiom of Choice}

\newcommand{\LEM}{\L^{=}_{\in}}
\newcommand{\KLEM}{\K_{\LEM}}
\newcommand{\vklem}{\vdash_{\KLEM}}

\newcommand{\tfr}{\upharpoonright} % half up-arrow for transfinite recursion (tfr)
