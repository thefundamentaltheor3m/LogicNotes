...
\newcounter{ZF}
\setcounter{ZF}{0}
\newtheorem{zfaxiom}[ZF]{ZF Axiom}
\newenvironment{baxiom}{
    \begin{tcolorbox}[colback=cyan!10!white,colframe=cyan!70!black, breakable, enhanced]\begin{zfaxiom}
}{
    \end{zfaxiom}\end{tcolorbox}
    % \addtocounter{ZF}{1}
}
