...
\begin{boxproposition}[Analogue of Lindenbaum's Lemma]
...
\end{boxtheorem}
\begin{proof}
    \sorry % Appendix in David Ang's notes?
\end{proof}

We now introduce more notation.
...
\Cref{Ch2:Cor:KLCompleteness_Closed_Formulae} gives us a converse of the Soundness Theorem for closed formulae. But it turns out we can do better.
