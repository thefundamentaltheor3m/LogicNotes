...
\begin{boxdefinition}[Terms]\label{Ch2:Def:Terms_FO_Logic}
...
\begin{boxdefinition}[Atomic Formula]\label{Ch2:Def:AtomicFormula_FO_Logic}
...
\begin{boxexample}[Interpreting a Term in Groups]\label{Ch2:Eg:Language_and_Formula_for_Groups}
